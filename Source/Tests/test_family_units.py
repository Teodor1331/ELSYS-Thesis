...
def test_mating_unit_instances():
...
def test_mating_unit_constructor():
    ...
    with pytest.raises(AssertionError):
        MatingUnit(0, individual1, individual4)
        MatingUnit(0.0, individual2, individual5)
        MatingUnit(True, individual3, individual6)

        MatingUnit('pedigree', 0, individual4)
        MatingUnit('pedigree', 0.0, individual5)
        MatingUnit('pedigree', 'Individual', individual6)

        MatingUnit('pedigree', individual1, 0)
        MatingUnit('pedigree', individual2, 0.0)
        MatingUnit('pedigree', individual3, 'Individual')

        MatingUnit('pedigree', individual1, individual4, 0)
        MatingUnit('pedigree', individual2, individual5, 0.0)
        MatingUnit('pedigree', individual3, individual6, False)
...
def test_sibship_unit_instances():
    sibship_unit1 = SibshipUnit('pedigree', None)
    sibship_unit2 = SibshipUnit('pedigree', None)
    sibship_unit3 = SibshipUnit('pedigree', None)
...
def test_sibship_unit_properties():
    ...
    assert sibship_unit1.pedigree_identifier == 'pedigree'
    assert sibship_unit2.pedigree_identifier == 'pedigree'
    assert sibship_unit3.pedigree_identifier == 'pedigree'
